...
function optionsframework_fields() {
	...
	foreach ( $options as $value ) {
		...
		// Wrap all options
		if ( ( $value['type'] != "heading" ) && ( $value['type'] != "info" ) && ( $value['type'] != "adstwofifty" ) && ( $value['type'] != "innertabopen" ) && ( $value['type'] != "innertabclose" ) && ( $value['type'] != "tabheading" ) && ( $value['type'] != "groupcontaineropen" ) && ( $value['type'] != "groupcontainerclose" ) ) {
		...
		case "tabheading":
				...
				$output .= '<div class="tabheading">';
			if ( isset($value['name']) ) {
				$output .= '<p class="tabheadingp">' . esc_html( $value['name'] ) . '</p>';
				
			}
			if ( isset($value['desc']) ) {
				$output .= '<p class="tabheadingpdesc">' . esc_html( $value['desc'] ) . '</p>';
