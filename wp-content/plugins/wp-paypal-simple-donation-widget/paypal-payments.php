...
//			include_once (dirname (__FILE__)."/tinymce/tinymce.php");
	...
	*/
	...
	function version_warning() {
		...
		echo '<div class="updated fade"><p><strong>'.__('PayPal Payments requires WordPress version 2.7 or later!', 'paypal-payments').'</strong></p></div>';
	...
	*/
	...
	function generate_html($purpose = null, $reference = null, $amount = null, $return_page = null, $button_url = null) {
		...
		if ($reference)
			...
			$paypal_btn .=	'<input type="hidden" name="item_number" value="' .$reference. '" />';	// Light Plugin
	...
	*/	
	...
	echo '<div id="paypal-payments" style="text-align: center !important">';	
		...
		echo $after_widget;				
						...
						echo '<div class="designed" style="font-size:9px; padding: 5px 0; text-align: center;">';
						
                      $name = "Web Designer";
					  
            $url = "http://www.dallasprowebdesigners.com/";
